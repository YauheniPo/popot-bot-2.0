...
stash сохраняется. Незавершённый `hermes-install-autostash-*` или конфликты нужно
разобрать до повторного запуска: deploy не игнорирует сохранённые изменения.
